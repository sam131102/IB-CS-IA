...
public class Home_Form extends javax.swing.JFrame {
    ...
    public Home_Form() {
        ...
        ImageIcon imgThisImg = new ImageIcon("src\\images\\satya.png");
    ...
    private void initComponents() {
        ...
        jMenu_ORDER_.setBackground(new java.awt.Color(27, 68, 99));
        jMenu_ORDER_.setForeground(new java.awt.Color(255, 255, 255));
        jMenu_ORDER_.setText("  BILL & ORDER  |");
        ...
        jMenu_PRODUCT_.setBackground(new java.awt.Color(27, 68, 99));
        ...
        jMenu_CATEGORY_.setBackground(new java.awt.Color(27, 68, 99));
        jMenu_CATEGORY_.setForeground(new java.awt.Color(255, 255, 255));
        jMenu_CATEGORY_.setText("PRODUCT TYPE |");
        ...
        jMenu5_USER_.setBackground(new java.awt.Color(27, 68, 99));
        jMenu5_USER_.setForeground(new java.awt.Color(255, 255, 255));
        jMenu5_USER_.setText("  USERS  |");
        ...
        jMenu_CUSTOMER_.setBackground(new java.awt.Color(27, 68, 99));
        jMenu_CUSTOMER_.setForeground(new java.awt.Color(255, 255, 255));
        jMenu_CUSTOMER_.setText("  BUYERS ");

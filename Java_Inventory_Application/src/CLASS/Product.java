...
public class Product {
    ...
    public Product(Integer ID, String NAME, Integer CATEGORY_ID, String PRICE, byte[] PICTURE, Integer QUANTITY, String categoryName)
    {
        this.id = ID;
        this.name = NAME;
    ...
    public static void insertProduct(Product product)
    {
        ...
        try {
            ps = con.prepareStatement("INSERT INTO `product`(`name`, `quantity`, `price`, `picture`, `category_id`) VALUES (?,?,?,?,?)");
    ...
    public static void updateProduct(Product product, boolean changeImage)
    {
        ...
        if(changeImage)
        {
            ...
            try {
            ps = con.prepareStatement("UPDATE `product` SET `name`=?,`quantity`=?,`price`=?,`picture`=?,`category_id`=? WHERE `id` = ?");
    ...
    public ArrayList<Product> productsList(String val){
        ...
        PreparedStatement ps;
               ...
               //String query = "SELECT product.id, product.name, category_id, quantity, price, picture,category.name as 'category' FROM product INNER JOIN category ON category.id = product.category_id";
        
               String query = "SELECT product.id, product.name,category_id, quantity, price, picture,category.name as 'category'\n" +
"  FROM product\n" +
...
"LIKE ?;";
        ...
        try {
            ...
            Product prd;
            // Integer ID, String NAME, Integer CATEGORY_ID, String PRICE, byte[] PICTURE, Integer QUANTITY, 
            while(rs.next()){
    ...
    public ArrayList<Product> productsInCategoryList(Integer categoryId){
        ...
        PreparedStatement ps;
               ...
               String query = "SELECT product.id, product.name,category_id, quantity, price, picture FROM product WHERE category_id = ?";
